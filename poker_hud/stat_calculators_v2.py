...
def calculate_vpip_v2(parsed: ParsedHand) -> Dict[str, Tuple[int, int]]:
    """
...
def calculate_pfr_v2(parsed: ParsedHand) -> Dict[str, Tuple[int, int]]:
    """
...
def calculate_3bet_v2(parsed: ParsedHand) -> Dict[str, Tuple[int, int]]:
    """
...
def calculate_bb100_v2(parsed: ParsedHand) -> Dict[str, Tuple[float, int]]:
    """
